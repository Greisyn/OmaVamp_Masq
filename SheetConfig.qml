...
// UI prefs + output path. Mirrors the OmaWolf SheetConfig.qml pattern:
// corner-anchored floating square anchor + card.
// Persists to ~/.config/omarchy/local.vampire-sheet.json
Item {
  id: root
  visible: false

  readonly property string home: Quickshell.env("HOME")
  readonly property string settingsPath: home + "/.config/omarchy/local.vampire-sheet.json"
