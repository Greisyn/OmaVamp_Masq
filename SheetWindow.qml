...
// Vampire: The Masquerade 20th Anniversary character sheet — open/close
// from the bar icon (left-click), IPC (show/hide/toggle), the card's X
// button, or Esc. No hover-dwell, no auto-collapse on mouse leave:
        ...
        Column {
          ...
          Row {
            ...
            Column {
              ...
              DotCell { label: "Awareness"; value: service.awareness; onDec: function() { service.bump("awareness", -1, 0, 5); } onInc: function() { service.bump("awareness", 1, 0, 5); } }
            ...
            Column {
              ...
              DotCell { label: "Finance"; value: service.finance; onDec: function() { service.bump("finance", -1, 0, 5); } onInc: function() { service.bump("finance", 1, 0, 5); } }
              ...
              DotCell { label: "Politics"; value: service.politics; onDec: function() { service.bump("politics", -1, 0, 5); } onInc: function() { service.bump("politics", 1, 0, 5); } }
