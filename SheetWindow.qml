...
// Corner-anchored floating sheet editor, modeled on the OmaWolf
// SheetWindow: a small always-visible square in a screen corner showing the
// V icon — hover-dwell (or tap) reveals the sheet card, leaving collapses it.
...
PanelWindow {
  ...
  WlrLayershell.namespace: "vampire-sheet"
  ...
  // ---- corner square with V icon ----
  Rectangle {
    id: cornerBtn
    objectName: "vampire-sheet-corner"
  ...
  Rectangle {
    id: surface
    objectName: "vampire-sheet-surface"
    x: root.cardX
    ...
    FocusScope {
      ...
      // header: transparent V20 logo only
      Image {
        id: logo
      ...
      Flickable {
        ...
        Column {
          ...
          FieldRow { label: "Clan"; initial: service.clan; onCommit: function(v) { service.clan = v; service.saveSoon(); } }
          FieldRow { label: "Generation"; initial: service.generation; onCommit: function(v) { service.generation = v; service.saveSoon(); } }
          FieldRow { label: "Sire"; initial: service.sire; onCommit: function(v) { service.sire = v; service.saveSoon(); } }
          ...
          DotRow { label: "Awareness"; value: service.awareness; onDec: function() { service.bump("awareness", -1, 0, 5); } onInc: function() { service.bump("awareness", 1, 0, 5); } }
          ...
          DotRow { label: "Finance"; value: service.finance; onDec: function() { service.bump("finance", -1, 0, 5); } onInc: function() { service.bump("finance", 1, 0, 5); } }
          ...
          DotRow { label: "Politics"; value: service.politics; onDec: function() { service.bump("politics", -1, 0, 5); } onInc: function() { service.bump("politics", 1, 0, 5); } }
          ...
          SectionSeparator { }
          SectionHeader { text: "VIRTUES / POOLS" }
          DotRow { label: "Conscience"; value: service.conscience; onDec: function() { service.bump("conscience", -1, 0, 5); } onInc: function() { service.bump("conscience", 1, 0, 5); } }
          DotRow { label: "Self-Control"; value: service.selfControl; onDec: function() { service.bump("selfControl", -1, 0, 5); } onInc: function() { service.bump("selfControl", 1, 0, 5); } }
          DotRow { label: "Courage"; value: service.courage; onDec: function() { service.bump("courage", -1, 0, 5); } onInc: function() { service.bump("courage", 1, 0, 5); } }
          DotRow { label: "Humanity"; max: 10; value: service.humanity; onDec: function() { service.bump("humanity", -1, 0, 10); } onInc: function() { service.bump("humanity", 1, 0, 10); } }
          ...
          DotRow { label: "Blood Pool"; max: 20; value: service.bloodPool; onDec: function() { service.bump("bloodPool", -1, 0, 20); } onInc: function() { service.bump("bloodPool", 1, 0, 20); } }
          ...
          MultiLine { label: "Disciplines (one per line)"; initial: service.disciplines; onCommit: function(v) { service.disciplines = v; service.saveSoon(); } }
          MultiLine { label: "Rituals / Paths"; initial: service.rituals; onCommit: function(v) { service.rituals = v; service.saveSoon(); } }
          ...
          MultiLine { label: "Other Traits"; initial: service.otherTraits; onCommit: function(v) { service.otherTraits = v; service.saveSoon(); } }
          MultiLine { label: "Combat"; initial: service.combat; onCommit: function(v) { service.combat = v; service.saveSoon(); } }
          ...
          MultiLine { label: "Clan Weakness"; initial: service.weakness; onCommit: function(v) { service.weakness = v; service.saveSoon(); } }
      ...
      Text {
        ...
        text: root.showAnchor ? (cfg.anchorLocked ? "Square locked · unlock in settings to drag · Esc closes" : "Drag the V square to move · drop near a corner to snap · Esc closes") : "Square hidden — open from the bar icon · Esc closes"
