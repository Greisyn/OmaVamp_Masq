...
BarWidget {
  ...
  readonly property var sheetService: bar && bar.shell ? bar.shell.serviceFor("local.vampire-sheet") : null
  ...
  WidgetButton {
    ...
    tooltipText: (root.charName !== "" ? root.charName : "Vampire Sheet") + "\nLeft click: toggle sheet\nRight click: settings"
    ...
    onPressed: function(b) {
      ...
      if (b === Qt.LeftButton) {
        Quickshell.execDetached(["omarchy-shell", "local.vampire-sheet", "toggle"]);
      }
    }
  }
}
