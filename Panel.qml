...
Panel {
  id: root
  moduleName: "local.vampire-sheet"
  ipcTarget: "local.vampire-sheet-panel"
  manageIpc: false
    ...
    Flickable {
      ...
      Column {
        ...
        Row {
          ...
          WidgetButton { text: "Show"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.vampire-sheet", "show"]); } }
          WidgetButton { text: "Hide"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.vampire-sheet", "hide"]); } }
          WidgetButton { text: "Toggle"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.vampire-sheet", "toggle"]); } }
          WidgetButton { text: "Export"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.vampire-sheet", "exportSheet"]); } }
        }
        ...
        SwitchRow { label: "Show floating V square (off = bar icon only)"; checked: config.showAnchor; onFlipped: config.set("showAnchor", !config.showAnchor) }
        ...
        Row {
          width: parent.width; spacing: Style.spacing.sm
          WidgetButton { text: "Export now"; onPressed: function() { Quickshell.execDetached(["omarchy-shell", "local.vampire-sheet", "exportSheet"]); } }
